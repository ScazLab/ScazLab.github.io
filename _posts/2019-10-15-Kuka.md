...
The joint limits was not set correctly as showed in <http://www.youbot-store.com/wiki/index.php/YouBot_Detailed_Specifications>.

#### Change 1

In ${youbot_description}/urdf/youbot_arm, open `limits.urdf.xacro`, change line 9-19 from:
...
```(xml)
  <property name="joint_1_limit_lower" value="${M_PI * -169 / 180}" />
  <property name="joint_1_limit_upper" value="${M_PI * 169 / 180}" />
  <property name="joint_2_limit_lower" value="${M_PI * -65 / 180}" />
  <property name="joint_2_limit_upper" value="${M_PI * 90 / 180}" />
  <property name="joint_3_limit_lower" value="${M_PI * -150 / 180}" />
  <property name="joint_3_limit_upper" value="${M_PI * 146 / 180}" />
  <property name="joint_4_limit_lower" value="${M_PI * -102.5 / 180}" />
  <property name="joint_4_limit_upper" value="${M_PI * 102.5 / 180}" />
  <property name="joint_5_limit_lower" value="${M_PI * -167.5 / 180}" />
  <property name="joint_5_limit_upper" value="${M_PI * 167.5 / 180}" />

  <property name="joint_1_limit_soft_lower" value="${joint_1_limit_lower + threshold}" />
  <property name="joint_1_limit_soft_upper" value="${joint_1_limit_upper - threshold}" />
  <property name="joint_2_limit_soft_lower" value="${joint_2_limit_lower + threshold}" />
  <property name="joint_2_limit_soft_upper" value="${joint_2_limit_upper - threshold}" />
  <property name="joint_3_limit_soft_lower" value="${joint_3_limit_lower + threshold}" />
  <property name="joint_3_limit_soft_upper" value="${joint_3_limit_upper - threshold}" />
  <property name="joint_4_limit_soft_lower" value="${joint_4_limit_lower + threshold}" />
  <property name="joint_4_limit_soft_upper" value="${joint_4_limit_upper - threshold}" />
  <property name="joint_5_limit_soft_lower" value="${joint_5_limit_lower + threshold}" />
  <property name="joint_5_limit_soft_upper" value="${joint_5_limit_upper - threshold}" />
```

#### Change 2

In `arm.urdf.xacro`, line 59, from
...
```
<limit effort="${9.5}" velocity="${M_PI / 2.0}" lower="${joint_1_limit_lower}" upper="${joint_1_limit_upper}"/>
```

#### Change 3

In `arm.urdf.xacro`, line 62, from
...
```
<safety_controller k_position="20" k_velocity="${9.5/M_PI / 2.0}" soft_lower_limit="${joint_1_limit_soft_lower}" soft_upper_limit="${joint_1_limit_soft_upper}" />
```

#### Change 4

In `arm.urdf.xacro`, line 100, from
...
```
<limit effort="${9.5}" velocity="${M_PI / 2.0}" lower="${joint_2_limit_lower}" upper="${joint_2_limit_upper}"/>
```

#### Change 5

In `arm.urdf.xacro`, line 101, from
...
```
<safety_controller k_position="20" k_velocity="${2*9.5/M_PI}" soft_lower_limit="${joint_2_limit_soft_lower}" soft_upper_limit="${joint_2_limit_soft_upper}" />
```

#### Change 6

In `arm.urdf.xacro`, line 144, from
...
```
<limit effort="${6}" velocity="${M_PI / 2.0}" lower="${joint_3_limit_lower}" upper="${joint_3_limit_upper}"/>
```

#### Change 7

In `arm.urdf.xacro`, line 145, from
...
```
<safety_controller k_position="20" k_velocity="50" soft_lower_limit="${joint_3_limit_soft_lower}" soft_upper_limit="${joint_3_limit_soft_upper}" />
```

#### Change 8

In `arm.urdf.xacro`, line 180, from
...
```
<limit effort="${2}" velocity="${M_PI / 2.0}" lower="${joint_4_limit_lower}" upper="${joint_4_limit_upper}"/>
```

#### Change 9

In `arm.urdf.xacro`, line 181, from
...
```
<safety_controller k_position="20" k_velocity="100" soft_lower_limit="${joint_4_limit_soft_lower}" soft_upper_limit="${joint_4_limit_soft_upper}" />
```

#### Change 10

In `arm.urdf.xacro`, line 216, from
...
```
<limit effort="1" velocity="${M_PI / 2.0}" lower="${joint_5_limit_lower}" upper="${joint_5_limit_upper}" />
```

#### Change 11

In `arm.urdf.xacro`, line 217, from
...
```
<safety_controller k_position="20" k_velocity="100" soft_lower_limit="${joint_5_limit_soft_lower}" soft_upper_limit="${joint_5_limit_soft_upper}" />
```
