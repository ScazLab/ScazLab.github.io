...
The version `indigo` is used for Kuka. Basically, you just need to follow [these instructions](http://wiki.ros.org/indigo/Installation/Ubuntu). The commands are listed here for your convenience.
